...
public:
	...
	CThread(_FUNCTION_ function, _ARGS_... args)
		:m_function(new CFunction<_FUNCTION_, _ARGS_...>(function, args...))
	{
		m_thread = 0;
		m_bpaused = false;
	}
...
public:
	template<typename _FUNCTION_, typename... _ARGS_>
	int SetThreadFunc(_FUNCTION_ function, _ARGS_... args)
	{
		m_function = new CFunction<_FUNCTION_, _ARGS_...>(function, args...);
...
private:
	...
	static void* ThreadEntry(void* arg) {
		...
		pthread_t thread = pthread_self();//不是冗余，有可能被stop把m_thread置0了
...
private:
	...
	pthread_t m_thread;
	bool m_bpaused;//true 线程暂停 false 线程运行

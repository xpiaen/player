...
LogInfo::LogInfo(const char* file, int line, const char* func, int pid, pthread_t tid, LogLevel level, const char* fmt, ...)
{
    const char sLevel[][8] = {
...
LogInfo::LogInfo(const char* file, int line, const char* func, int pid, pthread_t tid, LogLevel level)
{//自己主动发的日志
    const char sLevel[][8] = {
        "INFO","DEBUG","WARNING","ERROR","FATAL"
    };
...
LogInfo::LogInfo(const char* file, int line, const char* func, int pid, pthread_t tid, LogLevel level, void* pData, size_t nSize)
{
    const char sLevel[][8] = {
        "INFO","DEBUG","WARNING","ERROR","FATAL"
    };
